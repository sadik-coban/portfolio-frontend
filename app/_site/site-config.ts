...
export const site = {
    ...
    pages: {
        ...
        '/projects/car-price': { title: 'Car Price Prediction & MLOps', description: 'An end-to-end car-price prediction & MLOps system on CatBoost with MultiQuantile loss — data ingestion, training, drift monitoring, SHAP explainability and a serving API.' },
        ...
        '/projects/car-price/predict': { title: 'Price Prediction', description: 'Estimate a car’s market value with a CatBoost MultiQuantile model that returns a probabilistic price interval, not just a point estimate.' },
        ...
        '/projects/car-price/report': { title: 'Analytics Report', description: 'A full analytics report for the car-price pipeline: EDA, modelling, performance, drift and market dynamics.' },
