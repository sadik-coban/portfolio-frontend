...
const en: Dict = {
    ...
    'about.p2': 'Recently I built a full car-price prediction system: scraping the Turkish used-car market, training a CatBoost MultiQuantile model, and shipping a live dashboard with SHAP explanations and drift detection.',
    ...
    'home.heroH1': 'Building intelligent data solutions,',
    'home.heroH1Muted': 'end to end.',
    'home.heroSub': 'Bridging the gap between data science and production — the models, the pipelines, and the dashboards that make them useful.',
    ...
    'home.arsenalSub': 'Not a list of logos — what each tool actually did, across modelling, analysis, and production.',
    ...
    // Project overview
    'ov.badge': 'v2.0 Live · Probabilistic Prediction',
    'ov.title1': 'Beyond point predictions:',
    'ov.title2': 'Confidence intervals.',
    'ov.lead': 'Powered by CatBoost and FastAPI. Instead of guessing a single price, the model computes a probabilistic range from 10,000+ real market data points collected with custom scrapers.',
    ...
    'dr.errSame': 'Select two different versions to compare.',
    'dr.errFail': 'Analysis failed. Datasets may be missing or the server is unreachable.',
    'dr.errVersions': 'Could not fetch model versions. The backend may be down.',
    'dr.retry': 'Retry', 'dr.loadingVersions': 'Loading versions...',
    ...
    'shap.notFoundDesc': 'No SHAP summary was generated for this version, or the server is unreachable.',
...
const tr: Dict = {
    ...
    'about.p2': 'Yakın zamanda uçtan uca bir araç fiyatı tahmin sistemi kurdum: Türkiye ikinci el araç pazarından veri topladım, CatBoost MultiQuantile modelini eğittim ve SHAP açıklamaları ile drift tespiti içeren canlı bir pano yayınladım.',
    ...
    'home.heroH1': 'Akıllı veri çözümleri geliştiriyorum,',
    'home.heroH1Muted': 'uçtan uca.',
    'home.heroSub': 'Veri bilimi ile üretim arasındaki köprüyü kuruyorum: modeller, veri hatları ve onları işe yarar kılan panolar.',
    ...
    'home.arsenalSub': 'Bu bir logo listesi değil; her aracın modelleme, analiz ve üretimde gerçekte ne işe yaradığını gösteriyor.',
    ...
    // Project overview
    'ov.badge': 'v2.0 Canlı · Olasılıklı Tahmin',
    'ov.title1': 'Nokta tahminlerinin ötesinde:',
    'ov.title2': 'Güven aralıkları.',
    'ov.lead': 'CatBoost ve FastAPI ile çalışır. Model, tek bir fiyat söylemek yerine, özel kazıyıcılarla toplanan 10.000+ gerçek piyasa verisine dayanarak olasılıklı bir fiyat aralığı hesaplar.',
    ...
    'dr.errSame': 'Karşılaştırmak için iki farklı sürüm seçin.',
    'dr.errFail': 'Analiz başarısız oldu. Veri setleri eksik olabilir ya da sunucuya ulaşılamıyor.',
    'dr.errVersions': 'Model sürümleri alınamadı. Sunucu kapalı olabilir.',
    'dr.retry': 'Tekrar dene', 'dr.loadingVersions': 'Sürümler yükleniyor...',
    ...
    'shap.notFoundDesc': 'Bu sürüm için SHAP özeti üretilmemiş ya da sunucuya ulaşılamıyor.',
